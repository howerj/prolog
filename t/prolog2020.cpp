...
/* prolog2020.cpp: a simple Prolog interpreter written in C++,          */
/*           including an example test run as main().                   */
/* Copyright (c) Alan Mycroft, University of Cambridge, 2000-2020.      */
...
class Atom {
    string atomname;
public: Atom(string s) : atomname(s) {}
...
private:
    ...
    int size;
public:
    TermVarMapping(TermVar *vv[], string vt[], int vs)
...
{
   cout << "=======Append with traditional clause order:\n";
